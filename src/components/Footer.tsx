      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="footer py-12">
          <div>
            ...
            <Link href="/whistleblower-rights" className="link link-hover">Whistleblower Rights</Link>
          </div>
          
          <div>
            <span className="footer-title">Resources</span>
            <Link href="/guide" className="link link-hover">Reporting Guide</Link>
          ...
          <div>
            ...
            <Link href="/mission" className="link link-hover">Our Mission</Link>
          ...
          <div>
            ...
            <p className="text-sm opacity-75">
              For secure communication only:<br />
              contact@[domain].org
            </p>
            <p className="text-sm opacity-75">
              For emergencies:<br />
        ...
        <div className="footer footer-center p-4 border-t border-neutral-focus text-sm opacity-75">
          <p>&copy; {new Date().getFullYear()} Public Service Whistleblowers. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
