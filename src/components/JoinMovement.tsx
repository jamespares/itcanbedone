      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto opacity-90">
            We&apos;re building a network of professionals committed to public sector reform. 
            Your expertise and dedication can help transform UK public services.
          </p>
            ...
            <div className="card bg-primary-focus">
              <div className="card-body">
                ...
                <ul className="space-y-3 text-left opacity-90">
                  ...
                  <li>• Access legal and professional support</li>
